...
export type ChangeUserRoleControllerUpdateUserV1Data = {
...
export type ChangeUserRoleControllerUpdateUserV1Responses = {
    /**
     * The user's role has been successfully changed.
     */
    200: unknown;
};
