...
import type { PermissionV1Data, PermissionV1Response, PermissionV1Error, SwaggerData, SwaggerError, StatusData, StatusError, MigrateCollectionsV1Data, MigrateCollectionsV1Error, ImportCollectionsV1Data, ImportCollectionsV1Error, ViewCollectionsV1Data, ViewCollectionsV1Error, SetUserRolesV1Data, SetUserRolesV1Error, ViewMeV1Data, ViewMeV1Response, ViewMeV1Error, ViewUserV1Data, ViewUserV1Response, ViewUserV1Error, ViewUsersV1Data, ViewUsersV1Response, ViewUsersV1Error, ViewRoleIndexV1Data, ViewRoleIndexV1Response, ViewRoleIndexV1Error, UpdateRolesPermissionsV1Data, UpdateRolesPermissionsV1Response, UpdateRolesPermissionsV1Error, CreateRoleV1Data, CreateRoleV1Error, DeleteRoleV1Data, DeleteRoleV1Error, ViewRoleDetailV1Data, ViewRoleDetailV1Response, ViewRoleDetailV1Error, UpdateRoleV1Data, UpdateRoleV1Error, CreateFileV1Data, CreateFileV1Response, CreateFileV1Error, ConfirmFileUploadV1Data, ConfirmFileUploadV1Error, DeleteFileV1Data, DeleteFileV1Error, DownloadFileV1Data, DownloadFileV1Error, ViewContactIndexV1Data, ViewContactIndexV1Response, ViewContactIndexV1Error, CreateContactV1Data, CreateContactV1Response, CreateContactV1Error, DeleteContactV1Data, DeleteContactV1Error, ViewContactDetailV1Data, ViewContactDetailV1Response, ViewContactDetailV1Error, UpdateContactV1Data, UpdateContactV1Error, ViewPreferencesV1Data, ViewPreferencesV1Response, ViewPreferencesV1Error, UpdatePreferencesV1Data, UpdatePreferencesV1Error, CreateOneSignalTokenV1Data, CreateOneSignalTokenV1Response, CreateOneSignalTokenV1Error, SendPushNotificationV1Data, SendPushNotificationV1Error, ViewEventLogIndexV1Data, ViewEventLogIndexV1Response, ViewEventLogIndexV1Error, SearchCollectionsV1Data, SearchCollectionsV1Response, SearchCollectionsV1Error } from './types.gen';
import { zPermissionV1Response, zViewMeV1Response, zViewUserV1Response, zViewUsersV1Response, zViewRoleIndexV1Response, zUpdateRolesPermissionsV1Response, zViewRoleDetailV1Response, zCreateFileV1Response, zViewContactIndexV1Response, zCreateContactV1Response, zViewContactDetailV1Response, zViewPreferencesV1Response, zCreateOneSignalTokenV1Response, zViewEventLogIndexV1Response, zSearchCollectionsV1Response } from './zod.gen';
...
export const viewPreferencesV1 = <ThrowOnError extends boolean = true>(options: Options<ViewPreferencesV1Data, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ViewPreferencesV1Response, ViewPreferencesV1Error, ThrowOnError>({
        responseValidator: async (data) => {
            return await zViewPreferencesV1Response.parseAsync(data);
        },
...
export const updatePreferencesV1 = <ThrowOnError extends boolean = true>(options: Options<UpdatePreferencesV1Data, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<unknown, UpdatePreferencesV1Error, ThrowOnError>({
        url: '/api/v1/users/{userUuid}/preferences',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
export const viewEventLogIndexV1 = <ThrowOnError extends boolean = true>(options?: Options<ViewEventLogIndexV1Data, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ViewEventLogIndexV1Response, ViewEventLogIndexV1Error, ThrowOnError>({
        responseValidator: async (data) => {
            return await zViewEventLogIndexV1Response.parseAsync(data);
        },
