...
import AppAnimatedCard from '@/components/app/animated/card/AppAnimatedCard.vue'
import AppAnimatedCardItem from '@/components/app/animated/card/AppAnimatedCardItem.vue'
...
import SettingAppearanceMiniDashboard
  from '@/modules/setting/features/components/appearance/SettingAppearanceMiniDashboard.vue'
...
watch(darkMode, () => {
  preferences.update({
    theme: darkMode.value as UiTheme,
  })
})
</script>
      ...
      <div class="grid gap-lg max-w-160 lg:grid-cols-3">
        ...
        >
          <VcThemeProvider
            ...
            :theme="theme"
          >
            <AppAnimatedCard class="w-full">
              <AppAnimatedCardItem class="w-full">
                <div
