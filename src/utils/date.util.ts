...
export function formatDateToNullableDto(date: Date | string | null | undefined): string | null {
	if (!date) {
		return null
	}
...
// format: YYYY-MM
export function formatMonthToDto(date: Date | string | null): string | null {
	if (!date) {
		return null
	}
...
export function formatMonthToNullableDto(date: Date | string | null | undefined): string | null {
	if (!date) {
		return null
	}
...
export function formatStartEndDate(startDate?: Date | string, endDate?: Date | string): string {
	if (!startDate) {
		return '-'
	}
