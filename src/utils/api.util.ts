...
export function mapApiErrors<FormType, ResponseType>(error: unknown, keyMapping: Partial<Record<Mapping<FormType, ResponseType>, keyof ResponseType>> = {}): z.ZodFormattedError<unknown> {
