...
const { modalId = null, modalClasses = 'left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2' }
	= defineProps<Props>()
...
function showModal(): void {
  if (animateWithViewTransitionsApi.value)
    animateIn()
  else isModalActuallyShown.value = true
}

function hideModal(): void {
  if (animateWithViewTransitionsApi.value)
    animateOut()
  else isModalActuallyShown.value = false
